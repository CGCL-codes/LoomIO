...
std::vector<Option> get_global_options() {
  return std::vector<Option>({
    ...
    Option("osd_k_optimal", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description(""),
    ...
    Option("osd_gio_coordination_granularity", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(8)
    .set_description(""),

    Option("osd_gio_estimation", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description(""),
    ...
    Option("osd_gio_estimation_disk", Option::TYPE_INT, Option::LEVEL_ADVANCED)
    .set_default(0)
    .set_description("0:use average,1:use this value"),
